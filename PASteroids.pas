...
var ast:array[1..16]of elements;
    ...
    c:char;
    p,q,i,j,l,t:integer;
    shuttle:array[1..16,1..6,1..6]of boolean;  //disegni degli shuttle nelle 16 posizioni
...
begin
     for i:=1 to 6 do
         for j:=1 to 6 do
             shuttle[whitch2,i,j]:=false;
     for i:=1 to 6 do
         for j:=1 to 6 do
             shuttle[whitch2,i,7-j]:=shuttle[whitch1,i,j];
end;
...
begin
     ...
     for i:=1 to 6 do
         for j:=1 to 6 do
             shuttle[whitch2,7-i,j]:=shuttle[whitch1,i,j];
end;
...
begin
     ...
     for i:=1 to 6 do
         for j:=1 to 6 do
             shuttle[whitch2,i,j]:=shuttle[whitch1,j,i];
end;
     ...
     if shutorasts then    //true=asteroids, false=shuttles
        ...
        for i:=1 to 6 do
            begin
                 readln(source,line);
                 for j:=1 to 6 do
                     if line[j]='1' then shuttle[whitch,j,i]:=true
                                    else shuttle[whitch,j,i]:=false;
            end;
end;
...
begin
     ...
     with me do
          if (exx<>x)or(exy<>y)or(exdir<>dir) then
             for i:=x to x+5 do
                 for j:=y to y+5 do
                     if shuttle[dir,i-x+1,j-y+1] then
                        begin
                             p:=i;
                             q:=j;
...
begin
     with me do
          if (exx<>x)or(exy<>y)or(exdir<>dir) then
             for i:=exx to exx+5 do
                 for j:=exy to exy+5 do
                     if shuttle[exdir,i-exx+1,j-exy+1] then
                        begin
                             p:=i;
                             q:=j;
                             if p>155 then p:=1+(p-155);
...
begin
     crash:=0;
     for i:=me.x to me.x+5 do
         for j:=me.y to me.y+5 do
             if shuttle[me.dir,i+1-me.x,j+1-me.y] then
                for l:=1 to 16 do
                    if ast[l].lev>0 then
...
begin
     ...
     for i:=1 to 16 do
         with ast[i] do
            if lev>0 then
              if (((x>me.x-20)or(x<me.x+20))and(y>=me.y)and(y<me.y+5))or(((y>me.y-20)or(y<me.y+20))and(x>=me.x)and(x<me.x+5)) then farfromasteroids:=false;
end;
...
begin
     for i:=me.x to me.x+5 do
         for j:=me.x to me.y+5 do
             if shuttle[me.dir,i-me.x,j-me.y] then area[i,j]:=0;
     repeat
           me.x:=random(155)+1;
           me.y:=random(85)+1;
     until farfromasteroids;
