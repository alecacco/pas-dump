...
var x,j,k,y,i,penna,dim,background_color,writing_color,letter_color:integer;
    c,letter:char;
    pixel:array[1..80]of array[1..64]of array[1..2]of integer;
    pixletter:array[1..80]of array[1..56]of char;
    bitmap:text;
    percorso:string;
begin
repeat
...
write(' ');
        ...
        write('TRIAL VERSION!!!');
        gotoxy(21,7);
        write('per far scomparire questa schermata');
        gotoxy(21,8);
        write('e'' necessario comprare la licenza');
        gotoxy(17,10);
        write('inviare la richiesta con il sottostante codice a');
        gotoxy(31,13);
        write('''pylteam@aol.com''');
        gotoxy(28,15);
        write('codice: ################');
        gotoxy(19,20);
        write('premere un tasto qualsiasi per continuare...');
        c:=readkey;
        if c<>(chr(1)) then
           for i:=1 to 20 do
               begin
...
//        keybd_event(VK_MENU,56,0,0);
  //      keybd_event(VK_SPACE,37,0,0);
    //    keybd_event(VK_MENU,56,KEYEVENTF_KEYUP,0);
      //  keybd_event(VK_SPACE,37,KEYEVENTF_KEYUP,0);
        //keybd_event(0,49,0,0);
        //keybd_event(0,49,KEYEVENTF_KEYUP,0);
        clrscr;
        for i:=1 to 56 do
           for k:=1 to 80  do
                  begin
        ...
        repeat
           ...
           if (c='+')and(dim<6)and(x<81-dim)and(y<57-dim) then dim:=dim+1;
        ...
        if y=0 then y:=57-dim;
        if y=58-dim then y:=1;
        gotoxy(x,y);
